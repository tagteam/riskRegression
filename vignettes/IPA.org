...
#+RESULTS[(2025-09-05 15:26:35) 4ad587463242261d838b316f44356bc6b6112649]:
:results:
...
#+RESULTS[(2025-09-05 15:26:55) 1b832f895d12a85feea8e807fa4ca3edced723a1]:
:results:
...
#+RESULTS[(2025-09-05 15:27:11) 2bcd79c4cca9a135621f7e88a43adbe243da55d5]:
#+begin_example
...
Results by model:
          ...
          <fctr> <char>
1:    Null model   15.2
2: Exclusive ERG   14.8
3: Inclusive ERG   14.1
...
#+RESULTS[(2025-09-05 15:27:46) ab47285b61012d2bca8c73e0eb087b9e08233abe]:
:results:
...
#+RESULTS[(2025-09-05 15:27:55) 5bcf6350ff6f463c8beb576216fb983d9574bfa1]:
:results:
|  age | lpsaden | ppb5 | lmax | ct1 | diaggs | erg.status |  Y1 | risk.ex | risk.inc |
|------+---------+------+------+-----+--------+------------+-----+---------+----------|
...
Results by model:
           ...
           model times    IPA
          <fctr> <num> <char>
1: Exclusive ERG     3    6.4
2: Inclusive ERG     3   17.1
...
Results by model:
          ...
          <fctr> <num> <char>
1:    Null model     3   24.0
2: Exclusive ERG     3   22.4
3: Inclusive ERG     3   19.9
...
#+RESULTS[(2025-09-05 15:28:22) f4b18b24db785e34b067d3c4ce6c02234098476e]:
#+begin_example
...
#+RESULTS[(2025-09-05 15:28:40) b0817074933de144121448371b80edfbf281c9da]:
#+begin_example
   Variable Units                1                2 
...
#+RESULTS[(2025-09-05 15:28:48) 841985da41439efcbff01b0901042c38e91abda3]:
:results:
|  age | lpsaden | ppb5 | lmax | ct1 | diaggs | erg.status |  Y1 | risk.ex | risk.inc |
|------+---------+------+------+-----+--------+------------+-----+---------+----------|
...
#+RESULTS[(2025-09-05 15:28:58) 262eb718c337234dcf3f7891b3d3d55254f3b16c]:
#+begin_example
...
Results by model:
           ...
           model times    IPA
          <fctr> <num> <char>
1: Exclusive ERG     3    5.0
2: Inclusive ERG     3   17.5
...
Results by model:
          ...
          <fctr> <num> <char>
1:    Null model     3   24.5
2: Exclusive ERG     3   23.2
3: Inclusive ERG     3   20.2
