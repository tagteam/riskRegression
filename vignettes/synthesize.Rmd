...
The coefficents of the model with the simulated data from the recursive model are not particularly close to the original data. Perhaps this model models the data worse than the non-recursive model.
...
```
The parameters look to be quite close to each other.
