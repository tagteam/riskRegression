...
Functions =predict.CauseSpecificCox=, =predictCox= and =iid=:
7. Brice Ozenne, Anne Lyngholm S\o{}rensen, Thomas Scheike, Christian
   Torp-Pedersen and Thomas Alexander Gerds. riskRegression:
   Predicting the Risk of an Event using Cox Regression Models. The R
...
@article{ozenne2017,
  ...
  author =	 {Ozenne, Brice and S\o{}rensen, Anne Lyngholm 
