...
// getInfluenceFunctionAUCCompetingRisk
NumericVector getInfluenceFunctionAUCCompetingRisk(NumericVector time, NumericVector status, double tau, NumericVector risk, NumericVector GTiminus, double Gtau, double auc);
RcppExport SEXP _riskRegression_getInfluenceFunctionAUCCompetingRisk(SEXP timeSEXP, SEXP statusSEXP, SEXP tauSEXP, SEXP riskSEXP, SEXP GTiminusSEXP, SEXP GtauSEXP, SEXP aucSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type time(timeSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type Gtau(GtauSEXP);
    Rcpp::traits::input_parameter< double >::type auc(aucSEXP);
    rcpp_result_gen = Rcpp::wrap(getInfluenceFunctionAUCCompetingRisk(time, status, tau, risk, GTiminus, Gtau, auc));
    return rcpp_result_gen;
END_RCPP
}
// calcE_cpp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_riskRegression_getInfluenceFunctionAUCCompetingRisk", (DL_FUNC) &_riskRegression_getInfluenceFunctionAUCCompetingRisk, 7},
