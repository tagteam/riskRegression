...
#' @importFrom ggplot2 aes aes_string element_blank element_line element_rect geom_errorbar geom_line geom_point geom_ribbon ggplot scale_colour_manual scale_fill_manual scale_linetype_manual scale_y_continuous theme theme_bw "%+replace%" xlab 
